...
{
    /// <summary>
    /// RunModule422Response model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(RunModule422ResponseJsonConverter))]
    [DataContract(Name = "RunModule422Response")]
    internal class RunModule422Response : IOneOf
    {
        ...
        /// <summary>RunModule422Response Constructor</summary>
        /// <param name="value">The value as an object for RunModule422Response</param>
        /// <param name="type">The type for RunModule422Response</param>
        public RunModule422Response(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        public static RunModule422Response FromJson(string jsonString)
        {
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("RunModule422Response", DiscriminatorKey);
                }
        ...
        private static RunModule422Response DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new RunModule422Response(actualObject, concreteType);
        }

        private static RunModule422Response DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new RunModule422Response(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for RunModule422Response to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class RunModule422ResponseJsonConverter : JsonConverter
    {
